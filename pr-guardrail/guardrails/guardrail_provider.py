...
def make_guardrail_hook(
    ...
    # Stash the context on the hook function for programmatic access
    hook = ctx.before_tool_call  # type: ignore[attr-defined]
    hook.context = ctx  # type: ignore[attr-defined]
    return hook
